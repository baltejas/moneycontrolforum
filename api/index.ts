...
app.post('/', urlencodedParser, async function (req:any, res:any) {
  try {
    ...
    if(isSentiment === "false") {
      var query = req.body.query;
      var sectionId = "";
      var messages = "";
      const headers = {"sec-ch-ua":"'Chromium';v='128', 'Not;A=Brand';v='24', 'Google Chrome';v='128'", "sec-ch-ua-mobile": "?0", 
      ...
      res.render(__dirname + "/views/home.html", {result: "", messages:""});
    }
  } catch(e) {
